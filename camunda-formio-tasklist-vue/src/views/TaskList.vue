<template>
  <div v-if="token">
    <CamundaTasklist
      ...
      :webSocketEncryptkey=configs.GIR
      :getTaskId="getTaskId"
...
export default class TaskList extends Vue {
  ...
  async getToken () {    
    ...
    const url = "https://iam3.aot-technologies.com/auth/realms/forms-flow-ai-app3/protocol/openid-connect/token"
